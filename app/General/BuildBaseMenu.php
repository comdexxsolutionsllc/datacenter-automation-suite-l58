...
class BuildBaseMenu extends ProcessMenu implements MenuBuilder
{
    ...
    public static function buildMenu(): Collection
    {
        ...
        $output = collect(static::rArrayMergeDistinct($menuWithoutIcons, $icons))->filter(function ($value) {
            // note: should this be this way?
            return Arr::exists($value, 'id') ? $value : null;
        });
